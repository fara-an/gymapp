...
import epam.lab.gymapp.dto.TraineeRegistrationBody;
...
public class TraineeController {
    ...
    public ResponseEntity<String> register(@Valid @RequestBody TraineeRegistrationBody traineeRegistrationBody, HttpSession httpSession){
        LOGGER.debug(CONTROLLER + " executing register process");
        Trainee trainee =  new Trainee()
        traineeService.createProfile(traineeRegistrationBody)
